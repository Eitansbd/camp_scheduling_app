...
COPY public.activities (id, name, location, youngest_division_id, oldest_division_id, max_bunks, double) FROM stdin;
...
SELECT pg_catalog.setval('public.schedule_id_seq', 98, true);
...
SELECT pg_catalog.setval('public.time_slot_id_seq', 12, true);
